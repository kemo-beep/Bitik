...
- Name: phase9-matrix.spec.ts >> seller ships order from order detail (@critical)
- Location: tests/phase9-matrix.spec.ts:187:1
...
Call log:
  - waiting for getByRole('button', { name: 'Ship' }).first()
